'''
Credits for HACKERSHUBH

Original code: https://github.com/HACKERSHUBH/Face-Genaration-using-Generative-Adversarial-Network/blob/master/helper.py
'''
...
def download_celeba():
    """
    Added by Filipe Chagas
    """
    if(not os.path.exists('celeba')):
        os.mkdir('celeba')

    download_extract('celeba', 'celeba')
